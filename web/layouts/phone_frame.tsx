...
export default function PhoneFrame(): ReactElement {
  return (
    <div className="w-full h-full flex items-center justify-center bg-gray-50 dark:bg-gray-600">
      <div className="h-full relative border-gray-800 dark:border-gray-800 md:border-[14px] rounded-[2.5rem] h-full md:h-[800px] w-full md:w-[400px]">
        ...
        <div className="h-full md:rounded-[1.5rem] overflow-auto scrollbar-hide md:w-[372px] md:h-[772px] bg-white dark:bg-gray-800">
          <Outlet />
        </div>
      </div>
    </div>
